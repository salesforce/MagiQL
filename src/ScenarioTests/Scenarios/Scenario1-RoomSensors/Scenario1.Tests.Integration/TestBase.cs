...
namespace Scenarios.Scenario1.Tests.Integration
{
    ...
    {
        protected const string _platform = "Scenario1";
        ...
        protected SearchRequest SetupRequest(ReportsServiceClient client, string groupByColumnUniqueName, string sortByColumnUniqueName = null)
        {
            ...
            var groupBy = _allColumns.Data.Single(x => x.UniqueName.ToLower() == (sortByColumnUniqueName ?? groupByColumnUniqueName).ToLower());
